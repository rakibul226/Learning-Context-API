        ...
        <div className="navbar-end">
          {user?.email ? (
            <div className="dropdown dropdown-end">
              ...
              >
                <li>
                  <button className="btn btn-sm  btn-ghost hover:bg-gray-500 bg-gray-200 hover:text-white">
                    {user.displayName}
                  </button>
                </li>
                <li>
                  <button
                    onClick={logOut}
                    className="btn btn-sm  btn-ghost hover:bg-gray-500 bg-gray-200 hover:text-white"
                  >
                    Logout
                  </button>
                </li>
